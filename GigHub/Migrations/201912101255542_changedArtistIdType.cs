namespace GigHub.Migrations
{
    ...
    public partial class changedArtistIdType : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.Gigs", "ArtistId", c => c.Byte(nullable: false));
            RenameColumn(table: "dbo.Gigs", name: "ArtistId", newName: "Artist_Id");
            AddColumn("dbo.Gigs", "ArtistId", c => c.Byte(nullable: false));
