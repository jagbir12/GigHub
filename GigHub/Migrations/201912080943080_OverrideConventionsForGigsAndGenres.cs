namespace GigHub.Migrations
{
    ...
    public partial class OverrideConventionsForGigsAndGenres : DbMigration
    {
        public override void Up()
        {
            ...
            DropForeignKey("dbo.Gigs", "MyProperty_Id", "dbo.Genres");
            DropIndex("dbo.Gigs", new[] { "Artist_Id" });
            DropIndex("dbo.Gigs", new[] { "MyProperty_Id" });
            ...
            AlterColumn("dbo.Gigs", "MyProperty_Id", c => c.Byte(nullable: false));
            CreateIndex("dbo.Gigs", "Artist_Id");
            CreateIndex("dbo.Gigs", "MyProperty_Id");
            AddForeignKey("dbo.Gigs", "Artist_Id", "dbo.AspNetUsers", "Id", cascadeDelete: true);
            AddForeignKey("dbo.Gigs", "MyProperty_Id", "dbo.Genres", "Id", cascadeDelete: true);
        }
